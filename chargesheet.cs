...
{
    public partial class chargesheet : Form
    {
        ...
        public void Load_FIR_cmb()
        {
            conn = new SqlConnection(ConnString);
            string Sql = "SELECT slno,firid from tbl_firdetails order by firid";
        ...
        {
            view_chargesheet vs = new view_chargesheet(0);
            vs.Show();
        }
        ...
        private void savedata()
        {
            ...
            {
                string res = MessageBox.Show("Would You Like To Register Charge Sheet Record ?", "Save", MessageBoxButtons.YesNo).ToString();
                if (res == "Yes")
                {
                    ...
                    Sql1 = "insert into tbl_chargesheet(crid,firid,comid,sname,crdate,charges) values(" + int.Parse(textBox1.Text) + "," + int.Parse(comboBox1.Text) + "," + int.Parse(textBox2.Text) + ",'" + textBox3.Text + "','" + comb + "','" + textBox4.Text + "')";
                    ...
                    clear();
                    MessageBox.Show("Charge Sheet Created");
                }
                conn.Close();
            }
        }
        ...
        private void Button6_Click(object sender, EventArgs e)
        {
            ...
            string res = MessageBox.Show("Would You Like To Delete Charge Sheet Record ?", "Save", MessageBoxButtons.YesNo).ToString();
            if (res == "Yes")
            {
                conn.Open();
                ...
                Sql16 = "delete from tbl_chargesheet where slno='" + label7.Text + "'";
        ...
        public int GetID()
        {
            ...
            int cid =0;
            conn = new SqlConnection(ConnString);
            sql1 = "SELECT max(crid) from tbl_chargesheet";
        ...
        public void Load_Complaint()
        {
            try
            {
                ...
                conn = new SqlConnection(ConnString);
                sql1 = "SELECT * from firdetails_view where firid='" + comboBox1.Text + "'";
                ...
                if (rs.Read())
                {
                    ...
                    textBox2.Text = rs["comid"].ToString();
                    textBox3.Text = rs["cbyname"].ToString();
               }
                conn.Close();
            }
            catch (Exception ex)
